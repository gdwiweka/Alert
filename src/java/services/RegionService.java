...
public class RegionService {
    ...
    public String hello(@WebParam(name = "name") String txt,
        ...
        return "Hello " + txt + " !, yang tinggal di jalan " + jalan;
    }
    ...
    public int Penambahan(@WebParam(name = "angka1") int angka1, @WebParam(name = "angka2") int angka2) {
    ...
    public Region getById(@WebParam(name = "id") String id) {
        //TODO write your implementation code here:
        return irc.getById(id);
    }
